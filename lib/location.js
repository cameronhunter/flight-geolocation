define(['flight/lib/component'], function(defineComponent) {
  ...
  function currentLocation() {
    ...
    this.currentLocation = function() {
      navigator.geolocation.getCurrentPosition(this.locationUpdate.bind(this), this.locationError.bind(this), this.attr);
    };

    this.watchLocation = function() {
      this.watchId = navigator.geolocation.watchPosition(this.locationUpdate.bind(this), this.locationError.bind(this), this.attr);
    };
